<?php
namespace AkkaFeedback\Test\Fixture;
...
class FeedbacksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'feedback' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        'referrer' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2015-12-30 00:00:07',
            'modified' => '2015-12-30 00:00:07'
        ],
    ];
}
